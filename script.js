const allQuestions = [
  ...
  {q:"<b>Какие зоны делятся в структуре воздушного пространства?</b>", a:["Открытые, ограниченные, закрытые","Только открытые","Только закрытые"], correct:0, difficulty:"easy", category:"Воздушный кодекс"},
  ...
  {q:"<b>Что грозит за незаконное проникновение на ЗОТ?</b>", a:["Уголовная ответственность по статьям 12.6 / 12.7","Никаких мер","Только штраф"], correct:0, difficulty:"medium", category:"Закон о ЗОТ"},
  ...
  {q:"<b>Какая обязанность сотрудника при нарушении правил внутреннего устава?</b>", a:["Сообщить командиру","Игнорировать","Наказать себя"], correct:0, difficulty:"medium", category:"Внутренний устав"},
